import{_ as k,a as p,c as m,p as V,q as h,b as e,e as B,L as w,F as Q,l as y,v as L,K as A,t as C,r as d,E as r,m as D}from"./index-DhsVR2Cs.js";import{G as b}from"./GlassCard-B6xE04gB.js";import{u as M}from"./logs-0DCPq7Fj.js";const S={class:"version-manual"},E={class:"toolbar"},U={class:"version-select"},I=["value"],$={class:"search-wrap"},j=["disabled"],R={class:"manual-content"},F={__name:"VersionManual",setup(K){const i=M(),a=d("QB-2024-V1.0"),l=d(""),u=d(!1),f=[{value:"QB-2024-V1.0",label:"QB-2024-V1.0 标准版"},{value:"QB-2024-V1.1",label:"QB-2024-V1.1 增强版"},{value:"QB-2025-V2.0",label:"QB-2025-V2.0 专业版"},{value:"QB-2025-V2.1",label:"QB-2025-V2.1 旗舰版"}],x={"QB-2024-V1.0":`起爆器版本手册 - QB-2024-V1.0
...
五、维护保养
定期校准和软件更新`},n=D(()=>x[a.value]||""),_=()=>{i.addLog("切换","版本手册",`切换版本: ${a.value}`)},v=async()=>{if(!l.value.trim()){r.warning("请输入搜索内容");return}u.value=!0,await new Promise(s=>setTimeout(s,500)),u.value=!1;const o=n.value.toLowerCase().indexOf(l.value.toLowerCase());o!==-1?r.success(`找到匹配内容，位于第 ${n.value.substring(0,o).split(`
